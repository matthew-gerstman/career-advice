...
# Money
---
<TallImage src="assets/money-100s.gif" />
---
<TallImage src="assets/money-diddy.gif" />
---
<TallImage src="assets/money-leo.gif" />
---
# Lifespan of a tech company
---
# Idea
<img style={{height:"60vh"}} src="assets/thinking.gif" />
---
# Founders
<img style={{height:"60vh"}} src="assets/founders.gif" />
---
<TallImage src="assets/bill-gates.jpg" />
---
<TallImage src="assets/steve-jobs.jpeg" />
---
<TallImage src="assets/evan-speigal.jpeg" />
---
<TallImage src="assets/travis-kalanick.jpg" />
---
# Founders Determine Company Culture From Day One
...
---
# Public Company
<img style={{height: '65vh'}} src='assets/parks-party.gif' />
<Notes>
...
---
# Big Companies Will often Have You Work on one thing
---
# Small companies will often have you work on many things
---
# Younger Companies Are More Likely to Pivot
<Notes>
  Explain what pivoting is.
</Notes>
---
<TallImage src="assets/fates-forever-ios.jpg" />
---
<TallImage src="assets/discord.png" />
---
<img style={{height: '50vh'}} src="assets/odeo.jpg" />
---
<TallImage src="assets/twitter.png" />
---
<img style={{height: '50vh'}} src="assets/tune-in.jpeg" />
---
<TallImage src="assets/youtube.jpg" />
---
# Ideally a company will pivot as early as possible
---
# Increasing Your Own value
---
...
<ul>
  <Appear>
    ...
    <li>✍️ Consider specializing in Something</li>          
  </Appear>
</ul>
<Notes>
  <ul>
...
---
<TallImage src="assets/self-taught.gif" />
---
<TallImage src="assets/bootcamp.jpg" />
---
<TallImage src="assets/college.gif" />
---
...
---
# Consider a CS degree to be worth two years of experience.
---
# Ethical Landmines
<Notes>
  <ul>
...
---
# I'm going to show you some real salaries.
---
# Startup Titles
<Notes>
  <ul>
    <li>Titles are given out pretty quickly at startups.</li>
    <li>These tend not to apply at big companies.</li>
  </ul>
</Notes>
---
# Junior Engineer
 <hr style={{borderColor: darkGreen}} />
<h2> CS Degree or 2 years experience</h2>
---
# Mid Level Engineer
<hr style={{borderColor: darkGreen}} />
<h2> 2 - 5 years of experience</h2>
---
# Senior Engineer
<hr style={{borderColor: darkGreen}} />
<h2> 5+ years of experience</h2>
---
# This only applies to startups
---
<div style={{fontSize: '0.70em'}}>

  # Real Salaries from an unfair workplace
 <hr style={{borderColor: darkGreen}} />
</div>
...
<div style={{transform: "scale(2)"}}>
  <TwitterTweetEmbed options={{conversation: 'none'}} tweetId="1122211569579044866" />
</div>
---
...
<Notes>
  <ul>
    <li>Spend a minute on how important this phrase is</li>
    <li>Comp makes you sound like you know what you're talking about</li>
    <li>I need you to internalize this phrase</li>
    <li>*Talk about the equal pay act*</li>
    <li>Recruiters will try and get around this, but keep repeating this phrase</li>
  </ul>
</Notes>
---
# Next Secret
...
---
<TallImage src="assets/exploding.gif" />
<Notes>
  <ul>
    <li>Common tactic here is to provide an exploding offer</li>
    <li>This is a trap.</li>    
  </ul>
</Notes>
---
<TallImage src="assets/planner.gif" />
<Notes>
  <ul>
    <li>To navigate, bring up timeline at the beginning</li>
...
---
# Years of experience is it's own form of leverage.
<Notes>
  The more experience you have the more they want you.
</Notes>
---
# Computer Science Degree
<Notes>
  <ul>
    <li>I meet a lot of really smart bootcamp grads these days</li>
    <li>CS Degrees are inherently valuable to a certain extent, paper + education</li>
    <li>The individual had four years of coding in their spare time</li>
    <li>Likely 1-3 internships at real companies</li>
    <li>The people doing all of the above are the ones making a fortune at big tech companies right of school</li>
    <li>If you don't have a CS degree you can be successful, but keep in mind you're gonna get paid less those first couple of years</li>
  </ul>
</Notes>
---
...
<div style={{display: 'grid',  "gridTemplateColumns": "1fr 1fr 1fr"}}>
  <div style={{display: 'flex', padding: 10}}>
    <TwitterTweetEmbed options={{conversation: "none"}} tweetId="1111767029663432704" />
  </div>
  <div style={{display: 'flex', padding: 10}}>
    <TwitterTweetEmbed options={{conversation: "none"}} tweetId="1111341955965829120" />
  </div>
  <div style={{display: 'flex', padding: 10}}>
    <TwitterTweetEmbed options={{conversation: "none"}} tweetId="1114611408086257665" />
  </div>
  <div style={{display: 'flex', padding: 10}}>
    <TwitterTweetEmbed options={{conversation: "none"}} tweetId="1111331372759547904" />
  </div>
  <div style={{display: 'flex', padding: 10}}>
    <TwitterTweetEmbed options={{conversation: "none"}} tweetId="1111339112655519744" />
  </div>
  <div style={{display: 'flex', padding: 10}}>
    <TwitterTweetEmbed options={{conversation: "none"}} tweetId="1111138040984985600" />
  </div>
</div>
---
...
<Notes>
  <ul>
      <li>💰 The process of getting your shares.</li>
      <li>📅 Standard deal is 1/4 of shares after 1 year.</li>
      <li>⏳ You join 01/01/2019, on 01/01/2020 you'll get 2,500 shares. This is called a cliff</li>
      <li>⌚️ After that it vests on some regular schedule (usually quarterly).</li>
  </ul>
</Notes>
---
...
---
<TallImage src="assets/accountant.gif" />
<Notes>
  If you're hitting your cliff and getting RSUs this is the year to hire an accountant
</Notes>
---
# Bonuses
<hr style={{borderColor: darkGreen}} />
